...
const links = [
  ...
  { href: "/schengen-assistance", label: "Шенген" },
  { href: "/process", label: "Процесс" },
  { href: "/documents", label: "Документы" },
  { href: "/countries", label: "Направления" },
  { href: "/faq", label: "FAQ" },
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-4 py-4 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs uppercase tracking-[0.24em] text-[var(--muted)]">Schengen support</div>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-3">
          <Link href="/portal/login" className="hidden text-sm text-[var(--muted)] transition hover:text-[var(--ink)] sm:inline-flex">
            Войти
          </Link>
