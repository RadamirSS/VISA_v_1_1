...
const servicePoints = [
  ...
  "Разъяснение ограничений по срокам и внешним системам",
  "Передача заявки менеджеру для ручной консультации"
];
...
const processPoints = [
  ...
  "После консультации менеджер предлагает следующий шаг по сопровождению"
];
...
export default function HomePage() {
  return (
    <>
        ...
        <div className="space-y-7">
          ...
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg text-[var(--muted)]">
              Сайт помогает быстро понять формат сопровождения, изучить страны подачи и оставить короткий запрос для менеджера. Никаких личных кабинетов, загрузки документов и платежных сценариев на этом этапе нет.
            </p>
          </div>
        ...
        <Card className="relative overflow-hidden bg-[linear-gradient(180deg,#1f4850_0%,#14363b_100%)] text-white">
          ...
          <div className="relative space-y-6">
            <div className="rounded-[24px] bg-white/10 p-5 backdrop-blur">
              ...
              <p className="mt-3 text-3xl font-semibold">Публичный сайт для первого контакта и ручной консультации</p>
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
              <Metric title="Сайт" value="Lead-first" note="короткая заявка без паспортных данных" />
              <Metric title="Маршрут" value="Consultation" note="страна подачи и следующий шаг обсуждаются вручную" />
      ...
      <Section eyebrow="О сервисе" title="Сайт работает как понятная точка первого контакта" description="Мы упростили интерфейс до маркетингового сайта и короткой заявки, чтобы не собирать лишние данные до первичной консультации.">
