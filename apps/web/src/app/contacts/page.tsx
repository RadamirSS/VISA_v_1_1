...
export default function ContactsPage() {
  return (
    <Section eyebrow="Контакты" title="Связаться с командой" description="Если вы не уверены в стране подачи или хотите начать с консультации, оставьте заявку на сайте или свяжитесь с нами по указанным каналам.">
