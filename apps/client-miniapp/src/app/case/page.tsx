...
export default function CasePage() {
  ...
  return (
    <AppShell title="Визовая заявка" subtitle="Здесь вы создаете заявку на подачу и отслеживаете следующий шаг.">
      ...
      {error && error !== "no_case" ? <section className="surface-card status-banner">{error}</section> : null}
            ...
            <div className="card-row">
              <div>
                ...
                <ul className="case-facts">
                  <li>Страна: {summary.case.desired_country_name_ru ?? "не выбрана"}</li>
                  <li>Город подачи: {summary.case.preferred_submission_city ?? "не выбран"}</li>
                  <li>Визовый центр: {summary.case.submission_provider ?? "не выбран"}</li>
